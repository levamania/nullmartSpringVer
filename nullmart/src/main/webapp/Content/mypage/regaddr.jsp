...
<form action="/null/AddrAddServlet" id="regAddrForm" method="get">
	...
	<tr>
		<td class="table_title" height="35px"> &nbsp;*수령인</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" size="40" id="delivperson"></td>
	</tr>
	<tr>
		...
		<td>
			...
			-<input type="text" size="13" id="phone12">-<input type="text" size="13" id="phone13">
		</td>
	</tr> 
	<tr>
		...
		<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			-<input type="text" size="13" id="phone22">-<input type="text" size="13" id="phone23">
		</td>
	</tr>
	<tr>
		<td class="table_title" height="35px" rowspan="2">&nbsp;*배송지주소</td>
		<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="post" id="sample4_postcode" placeholder="우편번호" size="30">
<input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"></td><tr><td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="addr" id="sample4_roadAddress" placeholder="도로명주소" size="30">
<input type="text" name="addr2" id="sample4_jibunAddress" placeholder="지번주소" size="30"><span id="guide" style="color:#999"></span></td><tr>
	</tr>
	<tr>
